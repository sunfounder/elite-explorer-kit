...
.. note:: このキットの異なるバージョンでは、異なるIMUモジュールが使用されている場合があります。お持ちのキットのバージョンに基づいて、適切なチュートリアルを選択してください。10軸IMUモジュールをお持ちの場合は、:ref:`basic_imu`\ を参照してください。GY-87モジュールをお持ちの場合は、このレッスンを参照してください。
