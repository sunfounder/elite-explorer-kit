...
.. image:: img/07_smart_fan_schematic.png
   :width: 80%
   :align: center
...
.. note::
    ...
    * You can open the file ``07_smart_fan.ino`` under the path of ``Elite-Explorer-Kit-main\fun_project\07_smart_fan`` directly.
