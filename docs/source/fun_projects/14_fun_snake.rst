...
.. image:: img/14_snake_schematic.png
   :width: 80%
   :align: center
...
.. note::
    ...
    * You can open the file ``14_snake.ino`` under the path of ``Elite-Explorer-Kit-main\fun_project\14_snake`` directly.
