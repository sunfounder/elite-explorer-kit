...
When an object is within a 30-centimeter range in front of the garbage can, its lid automatically opens. 
...
.. image:: img/08_smart_trash_can_bb.png
    :width: 70%
    :align: center
...
.. image:: img/08_smart_trash_can_schematic.png
   :width: 90%
   :align: center
...
.. note::
    ...
    * You can open the file ``08_smart_trash_can.ino`` under the path of ``Elite-Explorer-Kit-main\fun_project\08_smart_trash_can`` directly.
